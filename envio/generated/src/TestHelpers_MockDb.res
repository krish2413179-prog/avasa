...
@genType
and entities = {
    @as("AIRecommendation") aIRecommendation: entityStoreOperations<Entities.AIRecommendation.t>,
    @as("DailyMetrics") dailyMetrics: entityStoreOperations<Entities.DailyMetrics.t>,
    @as("LendingTransaction") lendingTransaction: entityStoreOperations<Entities.LendingTransaction.t>,
    @as("LivePortfolio") livePortfolio: entityStoreOperations<Entities.LivePortfolio.t>,
    @as("MarketTrend") marketTrend: entityStoreOperations<Entities.MarketTrend.t>,
    @as("PropertyAnalytics") propertyAnalytics: entityStoreOperations<Entities.PropertyAnalytics.t>,
    @as("PropertyPerformance") propertyPerformance: entityStoreOperations<Entities.PropertyPerformance.t>,
    @as("PropertyTransaction") propertyTransaction: entityStoreOperations<Entities.PropertyTransaction.t>,
    @as("PropertyUpdate") propertyUpdate: entityStoreOperations<Entities.PropertyUpdate.t>,
    @as("StreamTransaction") streamTransaction: entityStoreOperations<Entities.StreamTransaction.t>,
    @as("SwapTransaction") swapTransaction: entityStoreOperations<Entities.SwapTransaction.t>,
    @as("TransferTransaction") transferTransaction: entityStoreOperations<Entities.TransferTransaction.t>,
    @as("UserAnalytics") userAnalytics: entityStoreOperations<Entities.UserAnalytics.t>,
    @as("UserPortfolio") userPortfolio: entityStoreOperations<Entities.UserPortfolio.t>,
    @as("UserPreferences") userPreferences: entityStoreOperations<Entities.UserPreferences.t>,
    @as("YieldTransaction") yieldTransaction: entityStoreOperations<Entities.YieldTransaction.t>,
  }
  ...
  let entities = {
      aIRecommendation: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.AIRecommendation)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.AIRecommendation.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      dailyMetrics: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.DailyMetrics)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.DailyMetrics.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      lendingTransaction: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.LendingTransaction)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.LendingTransaction.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      livePortfolio: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.LivePortfolio)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.LivePortfolio.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      marketTrend: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MarketTrend)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MarketTrend.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      propertyAnalytics: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PropertyAnalytics)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PropertyAnalytics.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      propertyPerformance: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PropertyPerformance)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PropertyPerformance.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      propertyTransaction: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PropertyTransaction)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PropertyTransaction.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      propertyUpdate: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.PropertyUpdate)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.PropertyUpdate.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      streamTransaction: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.StreamTransaction)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.StreamTransaction.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      swapTransaction: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.SwapTransaction)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.SwapTransaction.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      transferTransaction: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TransferTransaction)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.TransferTransaction.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      userAnalytics: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.UserAnalytics)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.UserAnalytics.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      userPortfolio: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.UserPortfolio)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.UserPortfolio.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      userPreferences: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.UserPreferences)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.UserPreferences.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      yieldTransaction: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.YieldTransaction)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.YieldTransaction.t,
            >
          ),
          ~getKey=({id}) => id,
        )
